...
const excelPath = path.join(__dirname, 'uploads', 'ss_kyokwa_ipkyul_26.xlsx');
...
async function uploadData() {
  ...
  try {
    ...
    await dataSource.query('DELETE FROM susi_kyokwa_ipkyul');
    ...
    for (let i = 0; i < data.length; i++) {
      ...
      try {
        await dataSource.query(`
          INSERT INTO susi_kyokwa_ipkyul (
            ida_id,
            recruitment_2023, competition_rate_2023, additional_pass_rank_2023,
            actual_competition_rate_2023, student_record_grade_50_2023, student_record_grade_70_2023,
            recruitment_2024, competition_rate_2024, additional_pass_rank_2024,
            actual_competition_rate_2024, student_record_grade_50_2024, student_record_grade_70_2024,
            recruitment_2025, competition_rate_2025, additional_pass_rank_2025,
            actual_competition_rate_2025, student_record_grade_50_2025, student_record_grade_70_2025,
            recruitment_2026, competition_rate_2026, additional_pass_rank_2026,
            actual_competition_rate_2026, student_record_grade_50_2026, student_record_grade_70_2026
          ) VALUES (
    ...
    const result = await dataSource.query('SELECT COUNT(*) as count FROM susi_kyokwa_ipkyul');
